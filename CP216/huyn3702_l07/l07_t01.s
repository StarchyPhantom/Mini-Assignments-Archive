...
//=======================================================
//the lr was initally pointing to the wrong return address, since it was overwritten by
//other lr destinations to return here from lower/upper checker instead of the original
//destination in the "main" block of code, now it is preserved and will return there
